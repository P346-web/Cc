        ...
        <div className="transactions-list">
          {orders.map(order => (
            <div key={order.id} className="transaction-item">
              ...
              <div className="tx-info">
                <div className="tx-type">Purchase</div>
                <div className="tx-title">{order.listing_title}</div>
                <div className="tx-date">{new Date(order.created_at).toLocaleDateString()}</div>
              </div>
              <div className="tx-amount negative">-${parseFloat(order.amount).toFixed(2)}</div>
            </div>
          ))}
        </div>
      )}
